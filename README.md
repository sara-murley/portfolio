...
**Tools:** Python, R, SQL  
[Repository link] | [Report / notebook link]
...
- **Topic / Role** – Short description of research focus or contribution  
- **Topic / Role** – Short description

(You can later split this into *Academic Research* and *Professional Experience* if helpful.)
...
(Optional section — easy to remove or expand.)
...
*This site is built using GitHub Pages and Jekyll. Content is updated periodically as new projects are completed.*
